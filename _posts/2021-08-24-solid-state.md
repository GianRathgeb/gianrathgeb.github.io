...
I found another use called james, but it seems that he does not have any interesting files in (only .ssh but I have no permissions to go inside that directory), so I have to find a way do prives.
